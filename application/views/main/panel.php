...
$notificaciones_reloj = $this->principal->getNotificacionesReloj();
   ...
   <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="<?php echo base_url();?>index.php/notificaciones"><i class="fa fa-diamond"></i> <span class="nav-label">Notificaciones</span></a>
                ...
                <li>
                    <a href="<?php echo base_url();?>index.php/bodyshop"><i class="fa fa-diamond"></i> <span class="nav-label">BodyShop</span></a>

                </li>
                <li>
                    <a href="<?php echo base_url();?>index.php/bodyshop/tablero"><i class="fa fa-diamond"></i> <span class="nav-label">BodyShop Tablero</span></a>
                ...
                <li>
                    <a href="<?php echo base_url();?>index.php/permisos/permisos_gerente"><i class="fa fa-diamond"></i> <span class="nav-label">Permisos</span></a>
                ...
                <?php if($this->session->userdata('statusPerfil')==2){?>
                  <?php if($aux1 !=0){?>
                <li>
                    <!--<a href="<?php echo base_url();?>index.php/compras/ventas_facturacion/<?php echo $aux1;?>"><i class="fa fa-diamond"></i> <span class="nav-label">Ventas</span></a>-->
                     <a href="<?php echo base_url();?>index.php/ventas_facturacion"><i class="fa fa-diamond"></i> <span class="nav-label">Ventas</span></a>
                ...
                <?php if($us->p_garantias == 1){?>
                <li>
                    <a href="<?php echo base_url();?>index.php/garantias"><i class="fa fa-diamond"></i> <span class="nav-label">Garantías</span></a>
                  <?php }?>
                </li>
                <!-- <li>
              ...
              <li>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                        ...
                        <span class="label label-primary n-count"><?php echo count($notificaciones_reloj) ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                      <?php if(count($notificaciones_reloj) > 0){ ?>
                          <?php foreach ($notificaciones_reloj as $n) { ?>
