    ...
    function callback_guardar()
    {
      ...
      var contador = 0;
        $.each($(".tipo"), function(i, item) {
            ...
            if($(item).val()==''){
                contador = contador +1;
                $(".error_tipo_"+tipo).empty().append("Campo requerido");
                $(".error_tipo_"+tipo).css('color','red');
            }
      ...
      if(contador==0){
          ajaxJson(site_url+"/bodyshop/savePresupuesto", $('#frm').serialize(), "POST", true, function(result){ 
            ...
            ErrorCustom("Es necesario ingresar los datos requeridos del presupuesto");
        }
    }
    //TAB PRESUPUESTO
