                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <?php }?>
                                    ...
                                    @if ($estatus->estatusId == 6 || $estatus->estatusId == 7|| $estatus->estatusId == 8|| $estatus->estatusId == 10)
                                        ...
                                        @endif
                                    @endif
                                    <li class=""><a href="#tab-10" data-toggle="tab">Historial estatus </a></li>
                                    @if($this->session->userdata('id')==12 || $this->session->userdata('id')==1 || $this->session->userdata('id')==80 || $this->session->userdata('id')==88)
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="5">Aún no se han registrado cambios de estatus</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
...
<script>
  ...
  function asignarTodosParticipantes(){
    ajaxJson(site_url+"/bodyshop/asignarTodosParticipantes", {"idproyecto":$("#idproyectosave").val()}, "POST", true, function(result){ 
        if(result==1){
