...
$(document).ready(function(){
     ...
     * Custom Scrollbars
     */
    function scrollbar(className, color, cursorWidth, autohidemode) {
    ...
    if (!$('.login-content')[0]) {
        scrollbar('html', 'rgba(0,0,0,0.3)', '10px', false);
    }

    //Scrollbar Tables
    if ($('.table-responsive')[0]) {
        scrollbar('.table-responsive', 'rgba(0,0,0,0.5)', '5px', true);
    }

    //Scrill bar for Chosen
    if ($('.chosen-results')[0]) {
        scrollbar('.chosen-results', 'rgba(0,0,0,0.5)', '5px', true);
    }

    //Scroll bar for tabs
    if ($('.tab-nav')[0]) {
        scrollbar('.tab-nav', 'rgba(0,0,0,0.2)', '2px', true);
    }

    //Scroll bar for dropdowm-menu
    if ($('.dropdown-menu .c-overflow')[0]) {
        scrollbar('.dropdown-menu .c-overflow', 'rgba(0,0,0,0.5)', '0px', true);
    }

    //Scrollbar for rest
    if ($('.c-overflow')[0]) {
        scrollbar('.c-overflow', 'rgba(0,0,0,0.5)', '5px', true);
    }

    //Scroll for sidebar-inner
    if ($('.sidebar-inner')[0]) {
        scrollbar('.sidebar-inner', 'rgba(0,0,0,0.5)', '5px', false);
    ...
    */
    ...
    if ($('.login-content')[0]) {
        ...
        $('body').on('click', '.login-navigation > button', function(){
	...
	fs.on('click', function(e) {
	    e.preventDefault();
	    localStorage.setItem('ma-full-status', 1);
	    //Launch
	    var layoutStatus = localStorage.getItem('ma-full-status');
   		if (layoutStatus == 1) {
		...
		localStorage.setItem('ma-full-status', 2);
